...
static void test_send_zc_zombie_completion_keeps_notification_reference(void)
{
#ifdef DDUP_TESTING
    DD_CHECK_EQ_INT(0, server_test_send_zc_zombie_completion());
#endif
}

static void test_bus_publish_fast_path_rejects_trailing_payload(void)
{
#ifdef DDUP_TESTING
    DD_CHECK_EQ_INT(0, server_test_publish_frame_validation());
#endif
}

static void test_bus_protocol_rejects_invalid(void)
{
#ifdef DDUP_TESTING
    DD_CHECK_EQ_INT(0, server_test_bus_protocol_rejects_invalid());
#endif
}

static void test_cluster_bus_port_validation(void)
{
#ifdef DDUP_TESTING
    DD_CHECK_EQ_INT(0, server_test_cluster_bus_port_validation());
#endif
}
...
static void test_cluster_clock_rollback_preserves_liveness(void)
{
#ifdef DDUP_TESTING
    DD_CHECK_EQ_INT(0, server_test_cluster_clock_rollback_preserves_liveness());
#endif
}

static void test_hotkeys_clock_rollback(void)
{
#ifdef DDUP_TESTING
    DD_CHECK_EQ_INT(0, server_test_hotkeys_clock_rollback());
#endif
}

static void test_scheduler_clock_rollback(void)
{
#ifdef DDUP_TESTING
    DD_CHECK_EQ_INT(0, server_test_scheduler_clock_rollback());
#endif
}
...
static void run_all_tests(void)
{
    ...
    DD_RUN(test_send_zc_zombie_completion_keeps_notification_reference);
