...
- mt 模式 `SHUTDOWN/MIGRATE/ASKING/KEYS/SCAN/RANDOMKEY/PSUBSCRIBE/PUNSUBSCRIBE` 仍记录为不支持；`SYNC/PSYNC/REPLICAOF/SLAVEOF/CLUSTER` 已由 worker 0 控制面适配（`mt_is_blocked` 当前清单：SHUTDOWN、MIGRATE、ASKING、KEYS、SCAN、RANDOMKEY、PSUBSCRIBE、PUNSUBSCRIBE）。
